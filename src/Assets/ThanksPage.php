...
abstract class ThanksPage {
    public static function get($code,$name)
    {
        $page = self::getHTML();
        $page = str_replace(array('{$NAME}', '{$OTPCODE}'), array($name, $code), $page);
        return $page;
    }
																								...
																								<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 30px;">
																									...
																									<tr>
																										<td class="h1 fw-medium" style="color:#51AAF4; font-family:\'SF Display\', Arial,sans-serif; font-size:26px; text-align:center; font-weight:600; padding: 0px 0px 20px;">
																											<div mc:edit="text_33">
																												Terima Kasih, {$NAME}.<br/> Segera Login Menggunakan<br/> Kode Verifikasi Kamu
																											</div>
																										</td>
																									</tr>
																									<tr>
																										<td class="plr-15" style="padding: 0px 100px;">
																													...
																													<td align="center" style="padding: 20px 0px;">
																														<table border="0" cellspacing="0" cellpadding="0">
																															<tr>
																																...
																																<td class="h2 fw-medium" style="color:#919191; font-family:\'SF Display\', Arial,sans-serif; font-size:42px; text-align:center; font-weight:700;">
																																	<div mc:edit="text_33">
																																		{$OTPCODE}
																																	</div>
																																</td>
