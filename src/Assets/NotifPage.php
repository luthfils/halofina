						...
						<td>
							<div mc:repeatable="Select" mc:variant="Section - Callout">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="">
									<tr>
										<td align="center" valign="top">
										<img src="https://halofina.com/img/verify/banner-min1.png" class="fluid-img" width="70%" height="auto" mc:edit="image_2" border="0" alt="" />
															...
															<tr>
																<td>
																	...
																	<div >
																		...
																		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: -10px; position: relative;">
																			<tr>
																				<td class="m-td" width="70" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																					...
																					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="box-shadow: 0px 4px 20px 0px rgba(0, 0, 0, 0.09); border-radius: 5px;" bgcolor="#ffffff">
																						<tr>
																							...
																							<td class="plr-15" style="padding: 30px 100px;">
																								<table width="100%" border="0" cellspacing="0" cellpadding="0">
																									<tr>
																										<td class="h1 fw-medium" style="color:#919191; font-family:\'SF Display\', Arial,sans-serif; font-size:18px; text-align:center; font-weight:600;">
																											<div mc:edit="text_33">
																												 {$MESSAGE}
																											</div>
																										</td>
